...
module.exports = class PruneCommand extends Command {
	...
	async run(msg, args) {
		if (!msg.member.permissions.has('MANAGE_MESSAGES') && msg.author.id !== msg.guild.ownerID) return msg.reply(':no_entry_sign: [**Invalid Permissions**]: You don\'t have the **Manage Messages** permission!');
		if (!msg.guild.member(this.client.user).permissions.has('MANAGE_MESSAGES')) return msg.reply(':no_entry_sign: [**Missing Permissions**]: I don\'t have the **Manage Messages** permission!');
